...
public class LocalTabAdapter extends RecyclerView.Adapter<LocalTabAdapter.MyViewHolder> {
...
//                mainLayout = (RelativeLayout) vi.findViewById(R.id.mainLayout);
    ...
    public LocalTabAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
