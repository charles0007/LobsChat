...
public class CityTabAdapter extends RecyclerView.Adapter<CityTabAdapter.MyViewHolder> {
...
//                mainLayout = (RelativeLayout) vi.findViewById(R.id.mainLayout);
    ...
    public CityTabAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
...
//
//}
        view.setOnClickListener(CityTabFragment.myOnClickListener);
